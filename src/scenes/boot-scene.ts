export class BootScene extends Phaser.Scene {
    ...
    preload(): void {
        ...
        this.load.image('bounds3_2', require('../assets/bounds3_1.png'))
        this.load.image('bounds4_1', require('../assets/bounds3_1.png'))
        this.load.image('bounds4_2', require('../assets/bounds3_1.png'))
